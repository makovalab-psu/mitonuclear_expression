## November 10, 2020 (Updated: April 8, 2021)
...
# Import 
df_global_anc = pd.read_table('globalK2_NATMER_v8.txt', sep='\t', header=None)
df_global_anc.columns = ['pop','subject','global_af','global_eu']
